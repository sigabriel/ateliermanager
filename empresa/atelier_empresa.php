						        ...
						        <nav class="main_nav">
							       <ul>
      								<li ><a  href="dashboard_empresa.php">Dashboard</a></li>
										<li ><a href="servico_empresa.php">Serviços</a></li>
										<li class="active"><a href="atelier_empresa.php">Atelier</a></li>
      								</ul>
      								</nav>
      							</div>
      					</div>
                ...
                <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle user-action"><img src="../images/icon.png" class="avatar" alt="Avatar"><h><?php echo $_SESSION['nome'];?></h></a>      
                    <ul class="dropdown-menu">
                      ...
                      <li><a href="../index.html"  class="dropdown-item"><i class="fa fa-power-off"></i> Logout</a></li>
                        ...
                        <button type="button" value="formulario/cadastro_atelier.php" class="btn btn-success" id="btn_modal" style="float:right;">Adcionar</button>
                  <?php include "codigo/tabela_atelier.php"; ?> 
						<!--//Moldal inicio//-->
						<div id="modal">
							<div class="box-modal">
