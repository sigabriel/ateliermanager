      					...
      					<div class="header_content d-flex flex-row align-items-center justify-content-start">
      						<div class="logo">
      							<a href="dashboard_atelier.php"><img src="../images/logo.png" alt=""></a>
      						      ...
      						      <nav class="main_nav">
        							 <ul>
										<li class="active"><a  href="dashboard_empresa.php">Dashboard</a></li>
		...
		<body>
			<div class="container">
				<div class="loaders1"><br>
						<div class="elements_title">Suzana Santos</div><br><br><br>
                                ...
                                <div class="au-card m-b-30">
                                    <div class="au-card-inner">
                           			...
                           			<div class="col-lg-5">
                                		<div class="au-card m-b-30">
                                   			<div class="au-card-inner">
                                        		<h3 class="title-2 m-b-40">Total de serviço da Empresa</h3>
